...
var id=React__default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner;function jd(a){a=a.type;return"string"===typeof a?a:"function"===typeof a?a.displayName||a.name:null}
  ...
  function reconcileChildFibers(returnFiber, currentFirstChild, newChild, expirationTime) {
    ...
    if (typeof newChild === 'undefined') {
      ...
      switch (returnFiber.tag) {
        ...
        case FunctionalComponent:
          {
            var Component$$1 = returnFiber.type;
            invariant(false, '%s(...): Nothing was returned from render. This usually means a return statement is missing. Or, to render nothing, return null.', Component$$1.displayName || Component$$1.name || 'Component');
          }
      }
    }
...
var ReactFiberBeginWork = function (config, hostContext, hydrationContext, scheduleWork, computeExpirationForFiber) {
  ...
  function mountIndeterminateComponent(current, workInProgress, renderExpirationTime) {
    ...
    if (typeof value === 'object' && value !== null && typeof value.render === 'function') {
      ...
      {
        var Component$$1 = workInProgress.type;

        if (Component$$1) {
          warning(!Component$$1.childContextTypes, '%s(...): childContextTypes cannot be defined on a functional component.', Component$$1.displayName || Component$$1.name || 'Component');
        }
...
// TODO: direct imports like some-package/src/* are bad. Fix me.
var createElement$$1 = createElement$1;
...
var extractor = function extractor(regex) {
...
//      
var key = 'reduxFormLatestVersion';

function getLatestVersion(current) {
  var fromCookie = js_cookie.get(key);
  return fromCookie && semver.lt(current, fromCookie) ? Promise.resolve(fromCookie) : new Promise(function (resolve) {
    fetch('https://api.github.com/repos/erikras/redux-form/tags').then(function (response) {
      response.json().then(function (tags) {
        tags.some(function (_ref) {
          var name = _ref.name;

          var latest = extract.tag(name);
          if (latest) {
            resolve(latest);
            js_cookie.set(key, latest, {
              expires: 0.04 /* 1 hour */
              , path: '/'
            });
            return true;
...
var key$1 = 'reduxFormDocCheckMute';

function isMuted() {
  return !!js_cookie.get(key$1);
}

function mute(days) {
  js_cookie.set(key$1, true, { expires: days, path: '/' });
}
...
var _templateObject3 = taggedTemplateLiteral(['margin: 4px;'], ['margin: 4px;']);
var _templateObject4 = taggedTemplateLiteral(['\n  font-family: Menlo, Consolas, \'Courier New\', monospace;\n'], ['\n  font-family: Menlo, Consolas, \'Courier New\', monospace;\n']);
var _templateObject5 = taggedTemplateLiteral(['margin: 15px 0;'], ['margin: 15px 0;']);
...
var DocCheck = function (_React$Component) {
  inherits$1(DocCheck, _React$Component);
  ...
  function DocCheck() {
    ...
    classCallCheck$1(this, DocCheck);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = DocCheck.__proto__ || Object.getPrototypeOf(DocCheck)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.mute = function (event) {
      event.preventDefault();
      _this.setState({ muted: true });
      mute();
    }, _temp), possibleConstructorReturn$1(_this, _ret);
  }

  createClass$1(DocCheck, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      var version = extract.url(document.location.href);
      this.setState({
        muted: isMuted(),
        version: version
      });
      getLatestVersion(version).then(function (latest) {
        _this2.setState({ latest: latest });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return latest && latest !== version && !muted ? React__default.createElement(
        Fixed,
        null,
        React__default.createElement(
          ...
          React__default.createElement(
            Close,
            { href: '#close', onClick: this.mute },
            React__default.createElement(Icon, { name: 'times' })
          ),
          React__default.createElement(
            Message,
            null,
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              GoTo,
              { href: document.location.href.replace(version, latest) },
              React__default.createElement(Icon, { name: 'calendar-check-o' }),
              ' Go To Latest'
            )
          ),
          React__default.createElement(
            Mute,
            { href: '#mute', onClick: this.mute },
            React__default.createElement(Icon, { name: 'clock-o' }),
            ' I know. Don\'t remind me for 7 days.'
          )
        )
      ) : null;
    }
...
var Fixed = styled.div(_templateObject);

var Container = styled.div(_templateObject2);

var Message = styled.div(_templateObject3);

var Version = styled.span(_templateObject4);

var GoToRow = styled.div(_templateObject5);

var GoTo = styled.a(_templateObject6);

var Mute = styled.a(_templateObject7);

var Close = styled.a(_templateObject8);

var dest = document.createElement('div');
document.body.appendChild(dest);
reactDom.render(React__default.createElement(DocCheck, null), dest);

})));
//# sourceMappingURL=doc-check.umd.js.map
